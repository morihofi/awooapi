...
public class RouterTest {
    ...
    @Test
    public void testAddAndRetrieveStaticHandler() {
        // Add a static endpoint
        router.addHandler(testEndpoint);

        // Retrieve handler by path and method
        Handler retrievedHandler = router.getHandler("/test", "GET");
    ...
    @Test
    public void testAddAndRetrieveVariableHandler() {
        ...
        Handler retrievedHandler = router.getHandler("/api/123", "GET");
    ...
    public void testHandlerNotFound() {
        ...
        Handler handler = router.getHandler("/notfound", "GET");
    ...
    public void testRemoveHandler() {
        ...
        Handler removedHandler = router.getHandler("/test", "GET");
        assertNull(removedHandler, "Handler should be null after being removed.");
    }

    @Test
    public void testRemoveVariableHandler() {
        ...
        // Ensure the handler is removed
        Handler removedHandler = router.getHandler("/api/123", "GET");
    ...
    @Test
    public void testGetHandlerWithDifferentHttpMethods() {
        ...
        Handler getHandler = router.getHandler("/resource", "GET");
        Handler postHandler = router.getHandler("/resource", "POST");
